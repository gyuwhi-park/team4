	...
	<div class="tableBox">
		...
		<tbody>
			<c:forEach items="${prePurchaseList}" var="pre">
				<tr>
					<td>${pre.product_name}<input type="hidden" class="cart_idx" value="${pre.cart_idx}"></td>
					<td class="product_idx">${pre.product_idx}</td>
		...
		<table border="1">
			<tbody>
				<tr>
					...
					<td><input id="user_name" name="user_name" value="${userInfo.user_name}"></td>
				</tr>
				<tr>
					<td>전화번호</td>
					<td><input id="user_phone" name="user_phone" value="${userInfo.user_phone}"></td>
				</tr>
				<tr>
					<td>우편번호</td>
					<td><input id="addr_post" name="addr_post" value="${userAddress.addr_post}"></td>
				</tr>
				<tr>
					<td>주소</td>
					<td><input id="addr_addr" name="addr_addr" value="${userAddress.addr_addr}"></td>
				</tr>
				<tr>
					<td>배송시 요청사항</td>
					<td><input id="purchase_option" name="purchase_option" value=""></td>
				</tr>
			</tbody>
		</table>
